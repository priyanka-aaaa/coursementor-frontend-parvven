...
import routes from "./universityAdmin/UniversityRoutes.js";
...
function UniversityLayout(props) {
    ...
    const [menuBackground, setmenuBackground] = useState("green");
    ...
    const getRoutes = (routes) => {
        return routes.map((prop, key) => {
            if (prop.layout === "/universityAdmin") {
                return (
                    <Route
                ...
                <ul className={width} id="accordionSidebar">
                    <span className="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                        {width === "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" ?
                            <Link to={'/universityAdmin/dashboard'}  >
                   ...
                   {currentMenu === "dashboard" ?
                        <li className="nav-item"
                            ...
                            <Link to={'/universityAdmin/dashboard'} className="nav-link current-tab" >
                        ...
                        : <li className="nav-item"
                            ...
                            data-toggle="tooltip" data-placement="right" title="University">
                            <Link to={'/universityAdmin/dashboard'} className="nav-link" >
                                <FontAwesomeIcon icon={faUniversity} />
                                <span>University</span></Link>
                        </li>}
                    {currentMenu === "courses" ?
                        <li onClick={() => handleCurrentClick("courses")} className="nav-item" data-toggle="tooltip" data-placement="right" title="Coures Listing">
                            <Link to={'/universityAdmin/courses'} className="nav-link current-tab" data-toggle="tooltip" data-placement="right" title="Coures Listing">
                        ...
                        <li onClick={() => handleCurrentClick("courses")}
                            ...
                            <Link to={'/universityAdmin/courses'} className="nav-link" data-toggle="tooltip" data-placement="right" title="Coures Listing">
                                <FontAwesomeIcon icon={faBook}
                    ...
                    {currentMenu === "commission" ?
                        <li className="nav-item "
                            ...
                            <Link to={'/universityAdmin/commission'} className="nav-link current-tab" href="#"
                                onClick={() => handleCurrentClick("commission")}

                            >
                                <FontAwesomeIcon icon={faClock} />
                                <span >Commission</span></Link>
                        </li>

                        : <li className="nav-item " data-toggle="tooltip" data-placement="right" title="Set Commission">
                            <Link to={'/universityAdmin/commission'} className="nav-link" href="#"
                                onClick={() => handleCurrentClick("commission")}
                    ...
                    {currentMenu === "summary" ?
                        ...
                        >
                            <Link to={'/universityAdmin/summary'} className="nav-link current-tab" href="#"
                                onClick={() => handleCurrentClick("summary")}
                            >
                                <FontAwesomeIcon icon={faClock} />
                        ...
                        >
                            <Link to={'/universityAdmin/summary'} className="nav-link" href="#"
                                onClick={() => handleCurrentClick("summary")}
                            >
                                <FontAwesomeIcon icon={faClock} />
                                <span >Summary Information</span></Link>
                        ...
                        >
                            ...
                            <div id="collapseTen" className="collapse" data-bs-parent="#accordion" data-parent="#accordionSidebar" >
                                <div className="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <Link to={'/universityAdmin/intake'} className="collapse-item" href="#">
