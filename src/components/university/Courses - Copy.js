...
export default function Courses() {
    ...
    const handleuniveristyExamChange = (e) => {
        ...
        const { univeristyExam } = UserInfoExam;
        // Case 1 : The user checks the box
        if (checked) {
            setUserInfoExam({
                univeristyExam: [...univeristyExam, value],
                response: [...univeristyExam, value],
            });
        }
        ...
        // Case 2  : The user unchecks the box
            ...
            setUserInfoExam({
                univeristyExam: univeristyExam.filter((e) => e !== value),
                response: univeristyExam.filter((e) => e !== value),
            });
        }
    };
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    if (Object.keys(student_universityOverview).length !== 0) {
                        ...
                        setmyallGroupsUserSpecific(allGroupsUserSpecific1)
                        var universityexam = student_universityOverview.exam
                                                                ...
                                                                <div className="row">
                                                                    <div className="col-12 col-sm-4 col-md-4 col-lg-4">
                                                                        <div className="form-group"><label >English Proficiency<span className="req-star">*</span>
                                                                            ...
                                                                            {arrayEnglish.map((element, index) => (
                                                                                <span style={{ color: "green" }} key={index}>{element}</span>

                                                                            ))}
                                                                            <br />

                                                                            IELTS<input type="checkbox" name="univeristyEnglishProficiency"
                                                                                value="IELTS"

                                                                                onChange={handleuniveristyEnglishProficiencyChange} />
                                                                            TOEFL<input type="checkbox" name="univeristyEnglishProficiency"
                                                                                value="TOEFL"

                                                                                onChange={handleuniveristyEnglishProficiencyChange} />
                                                                            Duolingo<input type="checkbox"
                                                                                name="univeristyEnglishProficiency"
                                                                                value="Duolingo"
                                                                                onChange={handleuniveristyEnglishProficiencyChange} />
                                                                            CPE<input type="checkbox"
                                                                                name="univeristyEnglishProficiency"
                                                                                value="CPE"
                                                                                onChange={handleuniveristyEnglishProficiencyChange}
                                                                            />
                                                                ...
                                                                <div className="row">
                                                                    ...
                                                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6">
                                                                        ...
                                                                        >Academic proficiency exam<span className="req-star">*</span></label>
                                                                            {arrayExam.map((element, index) => (
                                                                                <span style={{ color: "green" }} key={index}>{element}</span>

                                                                            ))}
                                                                            <br />

                                                                            GRE <input type="checkbox" name="univeristyExam"
                                                                                value="GRE"
                                                                                onChange={handleuniveristyExamChange} />
                                                                            GMAT <input type="checkbox" name="univeristyExam"
                                                                                value="GMAT"
                                                                                onChange={handleuniveristyExamChange} />
                                                                            SAT <input type="checkbox" name="univeristyExam"
                                                                                value="SAT"
                                                                                onChange={handleuniveristyExamChange} />
                                                                            Other <input type="checkbox" name="univeristyExam"
                                                                                value="Other"
                                                                                onChange={handleuniveristyExamChange} />
                                                                        </div>
                                                                    </div>
