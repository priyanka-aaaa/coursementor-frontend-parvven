                            ...
                            <div key={index}>
                                <div className="row mb-3">
                                    ...
                                    <div className="from-group">
                                        <label htmlFor="state" className="form-label">Relationship<span class="text-danger">*</span>
                                        </label>
                                        <select
                                    ...
                                    <div className="col-md-1">
                                        {element._id !== "null" ?
                                            ...
                                            : 
                                            <a title="Delet" className="btn  btn-danger deleteFamily" onClick={() => handleEmptyDeleteClick(index)}>
                                                <FontAwesomeIcon icon={faTrash} />
                                            </a>
                                            }
                                ...
                                <div className="row mb-3">
                                    ...
                                    <div className="col">
                                    <div className="from-group">
                                        <label htmlFor="state" className="form-label">Salutation<span class="text-danger">*</span></label>
                                        <select
                                    ...
                                    <div className="col">
                                    <div className="from-group">
                                        <label htmlFor="fname" className="form-label">First Name<span class="text-danger">*</span></label>
                                        <input
                                    ...
                                    <div className="from-group">
                                        <label htmlFor="lname" className="form-label">L-Name/
                                            S-name/ Family Name<span class="text-danger">*</span></label>
                                        <input
