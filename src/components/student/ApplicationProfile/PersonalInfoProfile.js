                                ...
                                <div className="mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-md-4" style={{ display: aadharDetail }}>
                                            ...
                                            <span style={{ color: "red" }}> {erroraadharCardNo}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="mb-3">
                                        <div className="row">
                                            <div className="col">
                                                ...
                                                <span style={{ color: "red" }}> {errorpassportNo}</span>
                                            </div>
                                            <div className="col">
                                                <div className="from-group">
                                                    <label htmlFor="Mname" className="form-label">Passport Issue Datee<span className="req-star">*</span></label>
                                                    <input
                                                        value={passportIssueDate || ""} 
                                                        onChange={(e) => setpassportIssueDate(e.target.value)}
                                                        type="text" className="form-control" placeholder="Middle Name" name="Mname" />
                                                </div>
                                                <span style={{ color: "red" }}> {errorpassportIssueDate}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mb-3">
                                        <div className="row">
                                            <div className="col">
                                                ...
                                                <span style={{ color: "red" }}> {errorpassportexpiryDate}</span>
                                            </div>
                                            <div className="col">
                                                <div className="from-group">
                                                ...
                                                <span style={{ color: "red" }}> {errorpassportCountry}</span>
                                            </div>
                                            <div className="col">
                                                <div className="from-group">
                                                ...
                                                <span style={{ color: "red" }}> {errorpassportBirthPlace}</span>
                                            </div>
                                ...
                                <div className="mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 text-right">
                                            ...
                                            <button type="submit" data-bs-toggle="collapse" className="btn btn-success " href="#collapseTwo" title="Save & Next">Save &
                                                Next</button>
                                        </div>
                                    </div>
                                </div>
