                        ...
                        <div className="main-content">
                          ...
                          <div className="container">
                            <div className="rs-about pt-120 pb-120 md-pt-80 md-pb-80 text-center grd-level">
                              <h2>Select your most relevant level of representation in any extracurricular activities?</h2>
                              {/* Tab panes */}
                              <div id="block1" className="container tab-pane  text-center"><br />
                                <h4> Higher the level of representation better the impact on your profile.</h4>
                                <from>                          
                                    ...
                                    <div className="row mb-3">
                                      ...
                                      <div className="col-md-4">
                                        <select className="form-control">
                                          ...
                                          <option>National level representation</option>
                                          <option>State level representation</option>
                                          <option>District level representation</option>                      
                                          <option>Intra-School level representation</option>
                                          <option>No representation</option>                                  
                                        </select>
                                      </div>
                                      <div className="col-md-4" />
                                    </div>
                                  </div> 
                                  <Link className="readon learn-more submit" to={'/Test'} href="#">
                                  Continue
                                          </Link>
