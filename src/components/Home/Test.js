    ...
    <div className="main-content">
      ...
      <div className="rs-breadcrumbs img1">
        <div className="breadcrumbs-inner text-center">
          <h1 className="page-title">Study Level</h1>
          <ul>
      ...
      <div className="container">
        <div className="rs-about pt-120 pb-120 md-pt-80 md-pb-80 text-center grd-level">
          ...
          <div className="tab-content">
            {/* <div id="block1" 
                                className="container tab-pane  text-center"> */}
            <br />
            ...
            <from>
              ...
              <div className="btn-part">
                <div className="form-group mt-4">
                  <Link to={'/AcademicTest'} className="readon learn-more submit" href="#">
                    Submit
            ...
            <div id="block3" className="container tab-pane fade"><br />
              <h3>Enter your score</h3>
              <from>
                <div className="row">
                  <div className="col-md-4" />
