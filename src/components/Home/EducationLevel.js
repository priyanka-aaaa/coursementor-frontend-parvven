      ...
      <div className="main-content">
        ...
        <div className="rs-breadcrumbs img1">
          <div className="breadcrumbs-inner text-center">
            <h1 className="page-title">BACHELORS DEGREE</h1>
            <ul>
        ...
        <div className="rs-about gray-color pt-120 pb-120 md-pt-80 md-pb-80 text-center grd-level">
          ...
          <ul className="nav nav-pills" role="tablist">
            <li className="nav-item">
              <a className="nav-link btn btn-outline-primary" data-toggle="pill" href="#home">Grade 12</a>
            </li>
            <li className="nav-item">
              <a className="nav-link btn btn-outline-primary" data-toggle="pill" href="#menu1">Undergraduate Diploma</a>
            </li>
          </ul>
          {/* Tab panes */}
          {/* <div className="tab-content"> */}
          <div id="home" className="container tab-pane  text-center"><br />
            <h3>What is your expected or gained percentage?</h3>
            <from>
              <div className="row">
              ...
              <div className="row mt-3">
                <div className="col-md-4" />
                <div className="col-md-4">  <input aria-invalid="false" id="Percentage" className="form-control" type="number" placeholder="Percentage" defaultValue multiple /></div>
                <div className="col-md-4" />
              </div>
              <div className="btn-part">
                <div className="form-group mt-4">
                <Link to={'/MajorPursue'} className="readon learn-more submit" href="#">
                   Submit
          ...
          <div id="menu1" className="container tab-pane fade"><br />
            ...
            <from>
              <div className="row">
                <div className="col-md-4" />
                <div className="col-md-4">  <input aria-invalid="false" id="Percentage" placeholder="Percentage" className="form-control" type="number" defaultValue multiple /></div>
                <div className="col-md-4" />
              </div>
              <div className="btn-part">
                <div className="form-group mt-4">
                  <a className="readon learn-more submit">submit</a>
